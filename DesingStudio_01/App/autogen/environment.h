...
Q_IMPORT_QML_PLUGIN(DesingStudio_01Plugin)
Q_IMPORT_QML_PLUGIN(DesingStudio_01ContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/DesingStudio_01Content/App.qml";
